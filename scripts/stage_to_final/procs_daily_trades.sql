-- Function: stg_to_final_daily_trades()

-- DROP FUNCTION stg_to_final_daily_trades();

CREATE OR REPLACE FUNCTION stg_to_final_daily_trades()
  RETURNS void AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION stg_to_final_daily_trades()
  OWNER TO wfp_admin;

--##########################################################################################
--##########################################################################################

-- Function: truncate_stg_daily_trades()

-- DROP FUNCTION truncate_stg_daily_trades();

CREATE OR REPLACE FUNCTION truncate_stg_daily_trades()
  RETURNS void AS
$BODY$
...
$BODY$
  LANGUAGE sql VOLATILE
  COST 100;
ALTER FUNCTION truncate_stg_daily_trades()
  OWNER TO wfp_admin;
