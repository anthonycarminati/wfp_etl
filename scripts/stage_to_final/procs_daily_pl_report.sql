-- Function: stg_to_final_pl_report()

-- DROP FUNCTION stg_to_final_pl_report();

CREATE OR REPLACE FUNCTION stg_to_final_pl_report()
  RETURNS void AS
$BODY$
...
SELECT CAST(account AS VARCHAR(50))
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION stg_to_final_pl_report()
  OWNER TO acarminati;