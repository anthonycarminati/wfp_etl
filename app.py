...
for file in os.listdir(g['DATA_DROP_PATH']):
    ...
    if '_Daily' in file:
        ...
        try:
            ...
            data_out.to_csv('{0}{1}'.format(g['DATA_CONVERTED_PATH'], file), sep='|')
